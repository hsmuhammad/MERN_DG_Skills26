...
// let multiply: (a: number, b: number) => number;  // let multiply: (a: number, b: number) means variable must contain a function that receives two numbers. | => number means function must return a number.
...
add("10", 20); // Error/ Qun ke add se typesript expect kr raha he ke number ho ga.
greet(123); //Error/ Qun ke greet se typesript expect kr raha he ke string ho ga.